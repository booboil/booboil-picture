package com.booboil.booboilpicturebackend.manager.sharding;
...
public class DynamicShardingManager {
    ...
    private void updateShardingTableNodes() {
        ...
        // booboil_picture.picture_112321321,booboil_picture.picture_1123213123
        String newActualDataNodes = tableNames.stream()
                .map(tableName -> "booboil_picture." + tableName) // 确保前缀合法
